<template>
  <div>
    <div class="d-flex flex-row">
      <deckcards cardsname="deckcards" class="item" :cardwidth=40 title="山札"></deckcards>
      <sidecards class="item"  :cardwidth=80 title="サイド"></sidecards>
      <lostzonecards class="item" cardsname="lostzonecards" :cardwidth=80 title="ロストゾーン"></lostzonecards>
      <cardokiba class="item" :cardwidth=60 cardsname="studiumscards" title="スタディアム"></cardokiba>
    </div>
    <div class="d-flex flex-row">
      <cardokiba class="item" :cardwidth=40 cardsname="battlecards" title="バトル場"></cardokiba>
      <trashcards class="item" :cardwidth=80 title="トラッシュ"></trashcards>      
    </div>
    <div class="d-flex flex-row">    
      <cardokiba class="item" :cardwidth=40 cardsname="bench1cards" title="ベンチ１"></cardokiba>
      <cardokiba class="item" :cardwidth=40 cardsname="bench2cards"　title="ベンチ２"></cardokiba>
      <cardokiba class="item" :cardwidth=40 cardsname="bench3cards"　title="ベンチ３"></cardokiba>
      <cardokiba class="item" :cardwidth=40 cardsname="bench4cards"　title="ベンチ４"></cardokiba>
      <cardokiba class="item" :cardwidth=40 cardsname="bench5cards"　title="ベンチ５"></cardokiba>
    </div>      
      <div class="row item">
	<div class="col">        
